window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".E6RFvq_wrap{position:relative}.E6RFvq_body{flex-direction:column;gap:6px;display:flex}.E6RFvq_badge{color:#3b6ea5;white-space:nowrap;background:#e3eefc;border:1px solid #c3dbf5;border-radius:999px;align-items:center;gap:4px;padding:1px 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;top:-8px;right:12px}.E6RFvq_reasoning{color:var(--dsw-text-tertiary,#888);font-size:12px}.E6RFvq_toolCall{font-family:var(--dsw-font-mono,monospace);color:var(--dsw-text-secondary,#666);font-size:12px}.E6RFvq_image{color:var(--dsw-text-secondary,#666);font-size:12px}.E6RFvq_other{color:var(--dsw-text-tertiary,#888);font-size:12px}";
