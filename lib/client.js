window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".E6RFvq_wrap{position:relative}.E6RFvq_body{flex-direction:column;gap:6px;display:flex}.E6RFvq_badge{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px;white-space:nowrap;position:absolute;top:-8px;right:12px}.E6RFvq_reasoning{color:var(--dsw-alias-label-tertiary);font-size:12px}.E6RFvq_toolCall{font-family:var(--dsw-font-mono,monospace);color:var(--dsw-alias-label-secondary);font-size:12px}.E6RFvq_image{color:var(--dsw-alias-label-secondary);font-size:12px}.E6RFvq_other{color:var(--dsw-alias-label-tertiary);font-size:12px}";
